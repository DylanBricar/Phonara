# Contributing to Phonara

Thank you for your interest in contributing to Phonara! This guide will help you get started with contributing to this open source speech-to-text application.

## 📖 Philosophy

Phonara aims to be the most forkable speech-to-text app. The goal is to create both a useful tool and a foundation for others to build upon—a well-patterned, simple codebase that serves the community. We prioritize:
...
2. **Clone your fork**:
   ...
   ```bash
   git clone git@github.com:YOUR_USERNAME/Phonara.git
   cd Phonara
   ```
...
Phonara follows a clean architecture pattern:
...
2. **Check discussions** at [github.com/DylanBricar/Phonara/discussions](https://github.com/DylanBricar/Phonara/discussions)
...
1. **Search existing discussions** at [github.com/DylanBricar/Phonara/discussions](https://github.com/DylanBricar/Phonara/discussions)
2. **Check common feature requests**:
   - [Post-processing / Editing Transcripts](https://github.com/DylanBricar/Phonara/discussions/168)
   - [Keyboard Shortcuts / Hotkeys](https://github.com/DylanBricar/Phonara/discussions/211)
...
4. Describe your feature idea including:
   ...
   - How it fits with Phonara's philosophy
...
2. **If something was previously closed** - If you want to revisit a closed issue or PR, you need to:
   ...
   - Gather community feedback first via [Discussions](https://github.com/DylanBricar/Phonara/discussions)
...
7. **Create a Pull Request**:
   ...
   **Remember:** PRs with community support are prioritized. If you haven't already, start a [discussion](https://github.com/DylanBricar/Phonara/discussions) to gather feedback before or alongside your PR. It is not explicitly required to gather feedback, but it certainly helps your PR get merged faster.
...
- **Discussions**: Ask questions in [GitHub Discussions](https://github.com/DylanBricar/Phonara/discussions)
- **Email**: Reach out at [contact@dylanbricar.be](mailto:contact@dylanbricar.be)

## 📜 License

By contributing to Phonara, you agree that your contributions will be licensed under the MIT License. See [LICENSE](LICENSE) for details.

---

**Thank you for contributing to Phonara!** Your efforts help make speech-to-text technology more accessible, private, and extensible for everyone.
