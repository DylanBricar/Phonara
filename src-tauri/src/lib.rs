...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            local_llm_cli::get_cli_provider_status,
            local_llm_cli::connect_cli_provider,
            ...
            shortcut::phonara_keys::start_phonara_keys_recording,
            shortcut::phonara_keys::stop_phonara_keys_recording,
            ...
            shortcut::setting_commands::get_recordings_directory,
            shortcut::setting_commands::set_recordings_directory,
            shortcut::setting_commands::clear_recordings_directory,
            shortcut::setting_commands::set_custom_sound_path,
            shortcut::setting_commands::clear_custom_sound_path,
