    ...
    pub fn new(app_handle: &AppHandle) -> Result<Self> {
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                description: "Best all-rounder. 6x faster than Large V3, 99 languages, 7.75% WER.".to_string(),
        ...
        available_models.insert(
            "distil-large-v3-fr".to_string(),
            ModelInfo {
                id: "distil-large-v3-fr".to_string(),
                name: "Distil Whisper French".to_string(),
                description: "5.9x faster than Whisper V3. 9.3% WER on French. Best speed/quality ratio.".to_string(),
                filename: "distil-large-v3-fr-q5_0.bin".to_string(),
                url: Some("https://huggingface.co/eustlb/distil-large-v3-fr-ggml/resolve/main/ggml-distil-large-v3-fr-q5_0.bin".to_string()),
                size_mb: 756,
                is_downloaded: false,
                is_downloading: false,
                partial_size: 0,
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                description: "NVIDIA multilingual. 25 EU languages. Fast and accurate. Transcription + translation.".to_string(),
                filename: "canary-1b-v2-int8".to_string(),
                url: Some("https://blob.handy.computer/canary-1b-v2-int8.tar.gz".to_string()),
                size_mb: 680,
                is_downloaded: false,
                is_downloading: false,
                partial_size: 0,
