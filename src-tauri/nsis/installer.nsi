; Custom NSIS template for Phonara with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Phonara for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Phonara releases. Require Data/
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Phonara Portable Mode"
    FileClose $0
