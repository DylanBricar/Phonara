...
NowStack provides multiple ways to embed and display your testimonials on your website or application.
...
<script>
  (function (w, d, s, o, f, js, fjs) {
    ...
    "script",
    "nowstack",
    "https://nowstack.melvynx.dev/widget/testimonials.js",
  );
...
```bash
npm install @nowstack/react-testimonials
```
...
const response = await fetch(
  "https://nowstack.melvynx.dev/api/v1/testimonials",
  {
    headers: {
...
- `.nowstack-testimonials` - Main container
- `.nowstack-testimonial` - Individual testimonial
- `.nowstack-content` - Testimonial content
- `.nowstack-author` - Author information
- `.nowstack-rating` - Star rating
- `.nowstack-company` - Company name
