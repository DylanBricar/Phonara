---
title: "Get Organization Member API"
description: "Retrieve one organization member with an API key."
keywords: ["api", "member", "members", "organizations", "api-keys"]
tags: ["api", "developer"]
order: 5
subcategory: "API"
method: "GET"
...
examples:
  ...
  javascript: |
    const response = await fetch("https://nowstack.melvynx.dev/api/v1/members/member_123", {
      headers: {
