...
const X64_SETUP =
  "https://github.com/DylanBricar/Phonara/releases/download/v0.9.4/Phonara_0.9.4_x64-setup.exe";
const ARM64_SETUP =
  "https://github.com/DylanBricar/Phonara/releases/download/v0.9.4/Phonara_0.9.4_arm64-setup.exe";
...
const manifest = {
  ...
  platforms: {
    ...
    "windows-x86_64-msi": {
      url: "https://github.com/DylanBricar/Phonara/releases/download/v0.9.4/Phonara_0.9.4_x64_en-US.msi",
    },
    "windows-aarch64-nsis": { url: ARM64_SETUP, signature: "…" },
    "darwin-aarch64": {
      url: "https://github.com/DylanBricar/Phonara/releases/download/v0.9.4/Phonara_aarch64.app.tar.gz",
    },
  },
};
